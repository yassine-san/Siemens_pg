...
const histogramData = {
    ...
    datasets: [
      ...
      { label: 'X_connectable', backgroundColor: '#FFC300', data: [5, 15, 25, 35, 45, 55] },
...
// histogramme 2
  const histogramData2 = {
    ...
    datasets: [
      ...
      { label: 'X_not RUH ready', backgroundColor: '#FFC300', data: [5, 15, 25, 35, 45, 55] },
  ...
  const histogramData3 = {
    ...
    datasets: [
      ...
      { label: 'X_Data not sent', backgroundColor: '#FFC300', data: [5, 15, 25, 35, 45, 55] },
  ...
  const histogramData4 = {
    ...
    datasets: [
      ...
      { label: 'Connection not active', backgroundColor: '#FFC300', data: [5, 15, 25, 35, 45, 55] },
  ...
  const histogramData5 = {
    ...
    datasets: [
      ...
      { label: 'X_NOT CAN24 Connectable', backgroundColor: '#FFC300', data: [5, 15, 25, 35, 45, 55] },
